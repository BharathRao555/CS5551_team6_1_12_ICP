...
public class TranslateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spin=(Spinner) findViewById(R.id.ddl_lang);
        ArrayAdapter<CharSequence> adapter=ArrayAdapter.createFromResource(this,R.array.str_Language,android.R.layout.simple_spinner_dropdown_item);
    ...
    public void translateText(View v) {
        ...
        Spinner spin=(Spinner) findViewById(R.id.ddl_lang);
        String toLang=spin.getSelectedItem().toString();
